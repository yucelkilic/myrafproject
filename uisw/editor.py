...
# Form implementation generated from reading ui file 'uisw/editor.ui'
#
...
class Ui_MainWindowEdit(object):
    def setupUi(self, MainWindowEdit):
        ...
        self.gridLayout_6.addWidget(self.groupBox_9, 0, 1, 2, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton, 0, 1, 2, 1)
    ...
    def retranslateUi(self, MainWindowEdit):
        ...
        self.pushButton.setText(_translate("MainWindowEdit", ":go", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindowEdit", "Cosmic", None))
