...
# Form implementation generated from reading ui file 'uisw/settings.ui'
#
...
class Ui_MainWindowSett(object):
    def setupUi(self, MainWindowSett):
        ...
        spacerItem = QtGui.QSpacerItem(299, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem, 0, 1, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(20, 393, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.gridLayout_10.addItem(spacerItem7, 5, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindowSett):
        ...
        self.groupBox.setTitle(_translate("MainWindowSett", "CPU", None))
        self.label.setText(_translate("MainWindowSett", "CPU count", None))
        self.label_2.setText(_translate("MainWindowSett", "CPUs to use", None))
