...
if __name__ == '__main__':
    ...
    print((
        'Elapsed time: {0} min {1} sec.'.format(elapsed // 60, elapsed % 60)))
    ...
    print(('\nA-Track has detected', n_moving,
        'moving objects and', n_uncertain, 'uncertain objects.'))
